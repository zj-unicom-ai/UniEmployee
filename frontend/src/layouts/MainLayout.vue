...
const adminOnlyNavOptions = [
  ...
  { label: '安全护栏', key: 'guard', icon: iconEl('<path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>') },
...
const pageTitleMap = {
  ...
  evaluation: '运行评估', profile: '个人档案', guard: '安全护栏',
}
...
const activeKey = computed(() => {
  ...
  // 安全护栏二级页（guard-words/guard-tools）统一高亮 guard 入口
  if (typeof n === 'string' && n.startsWith('guard-')) return 'guard'
  return n
})
